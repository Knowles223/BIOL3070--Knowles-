...
- [METHODS](#methods)
  - [Fill in 1st analysis e.g. box and
    whisker](#fill-in-1st-analysis-eg-box-and-whisker)
  - [Fill in 2nd analysis/plot e.g. two-sample
    t-test](#fill-in-2nd-analysisplot-eg-two-sample-t-test)
...
affect the level of abundance?

## Hypothesis

We predict that Northern counties in Utah will have a higher overall
abundance than Southern counties.

## Prediction

A possible test statistic is a two-sample t-test. This would allow us to
compare the two variables of north and south to determine which one has
a higher abundance.
...
This is where we will add a two-sample t-test analysis for our data set.
A two-sample t-test is a test to determine if there is a significant
difference between the two means. Which in our case would be north vs
south and the mean abundance of fireflies.
